...
function validateFile(file, allowedTypes, maxSize, typeName) {
  ...
  if (!allowedTypes.includes(file.type)) {
    throw new Error(`نوع الملف غير مدعوم لـ ${typeName}`);
  }
...
function uploadVideo(file, folder, cloudName, apiKey, apiSecret) {
...
function uploadImage(file, folder, cloudName, apiKey, apiSecret) {
...
function uploadPDF(file, folder, cloudName, apiKey, apiSecret) {
...
function uploadAttachment(file, folder, cloudName, apiKey, apiSecret) {
